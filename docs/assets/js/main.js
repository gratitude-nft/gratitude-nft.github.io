jQuery( document ).ready(function() {
    ...
    jQuery('#mint-page .they-can-mint').show();
    jQuery('#mint-page  .no-can-mint').hide();
    ...
    function fixFilter() {
      ...
      if(dataNeckUnique != "All") {
        jQuery(".gallery-img-wrapper:not(.gallery-img-wrapper[data-neck-unique='"+dataNeckUnique+"'])").hide();
      }
    }
    ...
    jQuery('#attribute-input-id').on('keyup',function(){
      ...
      jQuery(".attribute-select")[8].selectedIndex = 0;
    ...
    jQuery('.attribute-select').on('change',function(){
      ...
      dataNeckUnique = jQuery('#attribute-select-neck-unique').val();
    ...
    jQuery('#attribute-select-neck-unique').on('change',function() {
      jQuery('.gallery-img-wrapper').hide();

      jQuery(".gallery-img-wrapper[data-neck-unique='"+dataNeckUnique+"']").fadeIn();
